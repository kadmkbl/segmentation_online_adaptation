...
labels = [
    ...
    Label(  'lawn'                 ,  2 ,        2 , 'flat'            , 2       , False        , False        , (128,128,  0) ),
...
labels = [
    ...
    Label(  'lawn'                 ,  2 ,        2 , 'flat'            , 2       , False        , False        , (128,128,  0) ),
    Label(  'staircase'            ,  3 ,        3 , 'construction'    , 2       , False        , False        , (  0,128,  0) ),
    Label(  'curbs'                ,  4 ,      255 , 'construction'    , 2       , False        , True         , (128,  0,  0) ),
    Label(  'flowerbeds'           ,  5 ,        4 , 'construction'    , 2       , False        , False        , (192,  0,128) ),
    Label(  'chairs'               ,  6 ,      255 , 'construction'    , 2       , False        , True         , ( 64,128,128) ),
    Label(  'walls'                ,  7 ,      255 , 'construction'    , 2       , False        , True         , ( 64,  0,128) ),
    Label(  'posts'                ,  8 ,        5 , 'construction'    , 2       , False        , False        , (128,  0,128) ),
    Label(  'buildings'            ,  9 ,        6 , 'construction'    , 2       , False        , False        , (  0,128,128) ),
    Label(  'trees'                , 10 ,        7 , 'construction'    , 2       , False        , False        , (192,  0,  0) ),
    Label(  'fence'                , 11 ,      255 , 'construction'    , 2       , False        , True         , ( 64,128,  0) ),
    Label(  'manholecover'         , 12 ,      255 , 'construction'    , 2       , False        , True         , (192,128,128) ),
    Label(  'bus'                  , 13 ,        8 , 'vehicle'         , 3       , False        , False        , (  0,  0,128) ),
    Label(  'sky'                  , 14 ,        9 , 'sky'             , 4       , False        , False        , (192,128,  0) ),
    Label(  '_background_'         , 15 ,      255 , 'background'      , 5       , False        , True         , (  0,  0,  0) ),
]
